...
class Register extends Component {
  ...
  render() {
    ...
    const { visible, registering } = this.state;
        ...
        <Form onSubmit={this.handleSubmit} >
          ...
          <FormItem>
            ...
            >
              ...
              })(<Input size="large" type="password" onChange={this.handlePasswordChange} placeholder="至少6位密码，区分大小写" />)}
            </Popover>
          </FormItem>
          <FormItem>
          ...
          <FormItem>
            <Button size="large" type="primary" className={styles.submit} htmlType="submit" loading={registering}>注册</Button>
